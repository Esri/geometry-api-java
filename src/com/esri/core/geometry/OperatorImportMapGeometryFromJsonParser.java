...
abstract class OperatorImportMapGeometryFromJsonParser extends Operator {
	@Override
	public Type getType() {
		return Type.ImportMapGeometryFromJson;
	}
	 ...
	 */
	public abstract MapGeometryCursor execute(Geometry.Type type,
