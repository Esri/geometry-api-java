...
public class QuadTree {
	public static final class QuadTreeIterator {
		...
		/**
		 * Moves the iterator to the next Element_handle
		 *
		 * @return the Element_handle.
		 */
		public int next() {
			return m_impl.next();
		}
	 ...
	 *
	 * @param  extent
	 *         The extent of the Quad_tree.
	 *
	 * @param  height
	 *         The max height of the Quad_tree.
	 */
	 ...
	 * any active iterator on the Quad_tree.
	 *
	 * @param  element
	 ...
	 *
	 * @return an Element_handle corresponding to the element and bounding_box.
	 */
	 ...
	 *         This can be a handle obtained from a previous
	 *         insertion and is useful on data having strong
	 ...
	 * that this will invalidate any active iterator on the Quad_tree.
	 *
	 * @param  element_handle
	 *         The handle corresponding to the element and bounding_box
	 * to be removed.
	 */
	 ...
	 *
	 * @return the Quad_handle of the quad containing the given element_handle.
	 */
	...
	/**
	 * @return the number of elements in the Quad_tree.
	 */
	 ...
	 *         The tolerance used for the intersection tests.
	 *
	 * @return iterator on the quad tree for the given input parameters
	 */
	 ...
	 *         The tolerance used for the intersection tests.
	 *
	 * @return an iterator on the Quad_tree using the input Envelope_2D as the
	 * query.
	 */
