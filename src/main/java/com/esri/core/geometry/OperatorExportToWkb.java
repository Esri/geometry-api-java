...
public abstract class OperatorExportToWkb extends Operator {
     ...
     *
     * @return a ByteBuffer object containing the Geometry in WKB format
     */
     ...
     *         the callback used periodically by lengthy operations
     *
     * @return If the input buffer is null, then the size needed for the buffer
     *         is returned. Otherwise the number of bytes written to the buffer
     *         is returned.
     */
